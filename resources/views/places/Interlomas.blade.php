...
@section('mdescription', "Arreglos florales para toda ocasión con servicio de entrega exprés en la zona de Interlomas")

@section('mkeywords', "Florería en Interlomas, arreglos florales para toda ocasión, envío de flores a domicilio, florerías en Interlomas")

@section('title', "Florería en Interlomas")
